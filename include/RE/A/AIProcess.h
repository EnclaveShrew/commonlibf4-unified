...
class AIProcess
{
  public:
    ...
    [[nodiscard]] BSFaceGenAnimationData *GetFaceAnimationData(Actor &a_actor)
    {
        using func_t = decltype(&AIProcess::GetFaceAnimationData);
        static REL::Relocation<func_t> func{ID::AIProcess::GetFaceAnimationData};
    ...
    bool ProcessGreet(Actor *a_actor, DIALOGUE_TYPE a_type, DIALOGUE_SUBTYPE a_subType, TESObjectREFR *a_target,
                      BGSDialogueBranch *a_branch, bool a_forceSub, bool a_stop, bool a_que, bool a_sayCallback)
    {
    ...
    void SetActorsDetectionEvent(Actor *a_actor, const NiPoint3 &a_location, std::int32_t a_soundLevel,
    ...
    bool SetupSpecialIdle(Actor &a_actor, DEFAULT_OBJECT a_defaultObject, TESIdleForm *a_idle, bool a_testConditions,
