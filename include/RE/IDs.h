...
{
inline constexpr REL::VariantID Singleton{
    484974, 0}; // Inlined NG/AE - old ids 2192850 this function get by type (also, the number increased by 1)
}
...
inline constexpr auto AddItem = AddItem1;
} // namespace BGSInventoryList
