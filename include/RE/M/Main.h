...
class Main : public BSTEventSink<PositionPlayerEvent>
{
  public:
    ...
    // override
    virtual BSEventNotifyControl ProcessEvent(const PositionPlayerEvent &a_event,
                                              BSTEventSource<PositionPlayerEvent> *a_source) override; // 01
    ...
    void OnIdle()
    {
        using func_t = decltype(&Main::OnIdle);
        static REL::Relocation<func_t> func{ID::Main::OnIdle};
        return func(this);
    }
