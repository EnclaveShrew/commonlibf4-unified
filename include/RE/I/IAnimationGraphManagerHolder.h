...
class __declspec(novtable) IAnimationGraphManagerHolder
{
  public:
    ...
    virtual bool InitializeAnimationGraphVariables(
        [[maybe_unused]] const BSTSmartPointer<BShkbAnimationGraph> &a_newGraph) const
    {
        return true;
    } // 08
    virtual bool SetupAnimEventSinks([[maybe_unused]] const BSTSmartPointer<BShkbAnimationGraph> &a_newGraph)
    {
        return true;
    } // 09
    virtual void DoFailedToLoadGraph() const
    {
        return;
    } // 0A
    virtual bool CreateAnimationChannels(
        [[maybe_unused]] BSScrapArray<BSTSmartPointer<BSAnimationGraphChannel>> &a_channels)
    {
        return false;
    } // 0B
    virtual void PostCreateAnimationGraphManager(
        [[maybe_unused]] BSTSmartPointer<BSAnimationGraphManager> &a_animGraphMgr)
    {
        return;
    } // 0C
    virtual void PostChangeAnimationManager(
        [[maybe_unused]] const BSTSmartPointer<BSAnimationGraphManager> &a_newAnimGraphMgr,
        [[maybe_unused]] const BSTSmartPointer<BSAnimationGraphManager> &a_oldAnimGraphMgr)
    {
        return;
    } // 0D
    virtual bool ShouldUpdateAnimation()
    {
        return true;
    } // 0E
    ...
    virtual bool GetGraphVariableImpl([[maybe_unused]] std::uint32_t a_graphVarID, [[maybe_unused]] float &a_out) const
    {
        return false;
    } // 10
    virtual bool GetGraphVariableImpl([[maybe_unused]] std::uint32_t a_graphVarID, [[maybe_unused]] bool &a_out) const
    {
        return false;
    } // 11
    virtual bool GetGraphVariableImpl([[maybe_unused]] std::uint32_t a_graphVarID,
                                      [[maybe_unused]] std::int32_t &a_out) const
    {
        return false;
    }                                                                                                 // 12
    ...
    virtual void PreUpdateAnimationGraphManager(
        [[maybe_unused]] const BSTSmartPointer<BSAnimationGraphManager> &a_animGraphMgr) const
    {
        return;
    } // 16
    ...
    virtual void PreLoadAnimationGraphManager(
        [[maybe_unused]] const BSTSmartPointer<BSAnimationGraphManager> &a_animGraphMgr)
    {
        return;
    } // 18
    ...
    [[nodiscard]] bool CreateAnimationGraphManager(const BSScrapArray<BSStaticStringT<260>> &a_projects)
    {
        using func_t = decltype(&IAnimationGraphManagerHolder::CreateAnimationGraphManager);
        static REL::Relocation<func_t> func{ID::IAnimationGraphManagerHolder::CreateAnimationGraphManager};
        return func(this, a_projects);
    }
    ...
    bool SetAnimationGraphTargets(NiAVObject &a_target, bool a_attaching)
    {
        using func_t = decltype(&IAnimationGraphManagerHolder::SetAnimationGraphTargets);
        static REL::Relocation<func_t> func{ID::IAnimationGraphManagerHolder::SetAnimationGraphTargets};
        return func(this, a_target, a_attaching);
    }
    ...
    bool UpdateAnimationGraphManager(const BSAnimationUpdateData &a_updateData)
    {
        ...
        static REL::Relocation<func_t> func{ID::IAnimationGraphManagerHolder::UpdateAnimationGraphManager};
