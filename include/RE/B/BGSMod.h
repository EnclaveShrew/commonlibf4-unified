...
enum class WEAPON_PROPERTY : std::uint32_t
{
    kHasScope = 48,
    kZoomDataFOVMult = 49,
    kZoomData = 67
...
class Container : public BSTDataBuffer<2> // 00
{
  public:
...
{
    static REL::Relocation<BSTHashMap<const Mod *, TESObjectMISC *> *> mods{ID::BGSMod::Attachment::GetAllLooseMods,
                                                                            -0x8};
    return *mods;
}

class __declspec(novtable) Mod : public TESForm,              // 00
                                 ...
                                 public Container             // 88
{
  public:
    ...
    class Data : public Container::Data // 00
    {
      public:
        // members
...
namespace Template
{
class __declspec(novtable) Item : public TESFullName,      // 00
...
class __declspec(novtable) Items : public BaseFormComponent // 00
{
  public:
    static constexpr auto RTTI{RTTI::BGSMod__Template__Items};
    static constexpr auto VTABLE{VTABLE::BGSMod__Template__Items};

    static void CreateInstanceDataForObjectAndExtra(TESBoundObject &a_object, ExtraDataList &a_extra,
                                                    const INSTANCE_FILTER *a_filter, bool a_useDefault)
    {
    ...
    std::uint32_t GetFormComponentType() const override
    {
        return 'TJBO';
    } // 01
