...
class TaskQueueInterface
{
  public:
    ...
    void QueueRemoveActiveEffect(const ObjectRefHandle &a_ref, ActiveEffect &a_effect)
    {
        using func_t = decltype(&TaskQueueInterface::QueueRemoveActiveEffect);
        static REL::Relocation<func_t> func{ID::TaskQueueInterface::QueueRemoveActiveEffect};
        return func(this, a_ref, a_effect);
    }
    ...
    void QueueWeaponFire(TESObjectWEAP *a_weapon, TESObjectREFR *a_refObject, BGSEquipIndex a_equipIndex,
                         TESAmmo *a_ammo)
    {
